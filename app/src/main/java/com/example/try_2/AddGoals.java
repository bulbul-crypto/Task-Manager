...
public class AddGoals extends BottomSheetDialogFragment {
    ...
    public static AddGoals newInstance(){
        return new AddGoals();
    }
    @Override
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        newGoalText = Objects.requireNonNull(getView()).findViewById(R.id.new_goal_tv);
        newGoalSaveButton = getView().findViewById(R.id.new_goal_btn);
        ...
        db = new DatabaseHandlerForGoals(getActivity());
        db.openDatabase();
