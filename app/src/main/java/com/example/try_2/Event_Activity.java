...
public class Event_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rb = new EventDatabase(getApplicationContext());

        // Initialize views
        mToolbar = (Toolbar) findViewById(R.id.ab_events);
        mAddEventButton = (FloatingActionButton) findViewById(R.id.btn_add_event);
        mList = (RecyclerView) findViewById(R.id.rv_event);
        mNoReminderView = (TextView) findViewById(R.id.tv_no_events);

        // To check is there are saved reminders
        // If there are no reminders display a message asking the user to create reminders
        ArrayList<Event> mTest = rb.getAllReminders();
        ...
        public boolean onActionItemClicked(ActionMode actionMode, MenuItem menuItem) {
            switch (menuItem.getItemId()) {
                ...
                case R.id.discard_reminder:
                    ...
                    // Get the event id associated with the recycler view item
                    for (int i = IDmap.size(); i >= 0; i--) {
                        if (mMultiSelector.isSelected(i, 0)) {
                            int id = IDmap.get(i);

                            // Get reminder from reminder database using id
                            Event temp = rb.getReminder(id);
                            // Delete reminder
   ...
   // Create menu
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.main_menu_event, menu);
        return true;
    }
    ...
    public class SimpleAdapter extends RecyclerView.Adapter<SimpleAdapter.VerticalItemHolder> {
        ...
        public VerticalItemHolder onCreateViewHolder(ViewGroup container, int viewType) {
            ...
            View root = inflater.inflate(R.layout.event_item, container, false);
        ...
        public  class VerticalItemHolder extends SwappingHolder
            ...
            public VerticalItemHolder(View itemView, SimpleAdapter adapter) {
                ...
                // Initialize views
                mTitleText = (TextView) itemView.findViewById(R.id.recycle_event_title);
                mDateAndTimeText = (TextView) itemView.findViewById(R.id.recycle_event_date_time);
                mRepeatInfoText = (TextView) itemView.findViewById(R.id.recycle_event_repeat_info);
                mActiveImage = (ImageView) itemView.findViewById(R.id.iv_event_active_status);
                mThumbnailImage = (ImageView) itemView.findViewById(R.id.iv_thumbnail_image);
            }
            ...
            public boolean onLongClick(View v) {
                AppCompatActivity activity = Event_Activity.this;
        ...
        public ArrayList<ReminderItem> generateData(int count) {
            ArrayList<SimpleAdapter.ReminderItem> items = new ArrayList<>();

            // Get all reminders from the database
            ArrayList<Event> reminders = rb.getAllReminders();

            // Initialize lists
            ArrayList<String> Titles = new ArrayList<>();
            ArrayList<String> Repeats = new ArrayList<>();
            ArrayList<String> RepeatNos = new ArrayList<>();
            ArrayList<String> RepeatTypes = new ArrayList<>();
            ArrayList<String> Actives = new ArrayList<>();
            ArrayList<String> DateAndTime = new ArrayList<>();
            ArrayList<Integer> IDList= new ArrayList<>();
            ArrayList<DateTimeSorter> DateTimeSortList = new ArrayList<>();

            // Add details of all reminders in their respective lists
            for (Event r : reminders) {
